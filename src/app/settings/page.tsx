            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-subtle space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                {masterData.terms?.map((term: any) => (
                  <div key={term.id} className="p-4 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between">
                    <div>
                      <div className="flex items-center space-x-2">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-subtle space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                {masterData.classes?.map((c: any) => (
                  <div key={c.id} className="p-3.5 rounded-xl border border-slate-200 bg-slate-50 relative group">
